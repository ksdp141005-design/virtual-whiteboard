    ...
    case BOARD_ACTIONS.DRAW_MOVE: {
      ...
      switch (type) {
        ...
        case TOOL_ITEMS.BRUSH:
          const newBrushElement = { ...newElements[index] };
          newBrushElement.points = [...newBrushElement.points, { x: clientX, y: clientY }];
          newBrushElement.path = new Path2D(getSvgPathFromStroke(getStroke(newBrushElement.points)));
          newElements[index] = newBrushElement;
          return { ...state, elements: newElements };
        default:
